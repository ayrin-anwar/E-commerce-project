                    ...
                    <div class="col align-self-center d-none d-lg-block">
                        <div class="main-menu">
                            <ul>
                                ...
                                @auth
                                <li class="dropdown "><a href="#">Welcome,{{ Auth::user()->name }}<i class="pe-7s-angle-down"></i></a>
                                    <ul class="sub-menu">
        ...
        <div class="inner">
            ...
            <div class="body customScroll">
                <ul class="minicart-product-list">
                    <li>
                        <a href="single-product.html" class="image"><img src="{{ asset('front/images/product-image/1.jpg') }}"
                    ...
                    <li>
                        <a href="single-product.html" class="image"><img src="{{ asset('front/images/product-image/2.jpg') }}"
                                alt="Cart product Image"></a>
                        <div class="content">
                    ...
                    <li>
                        <a href="single-product.html" class="image"><img src="{{ asset('front/images/product-image/3.jpg') }}"
                                alt="Cart product Image"></a>
                        <div class="content">
        ...
        <div class="inner">
            ...
            <div class="foot">
                <div class="buttons mt-30px">
                    <a href="{{route('Cart')}}" class="{{ Route::is('Cart') ?'active':''}}">view cart</a>
                        ...
                        <div class="col-md-6 col-lg-3 mb-md-30px mb-lm-30px">
                            <div class="single-wedge">
                                <div class="footer-logo">
                                    <a href="index.html"><img src="{{ asset('front/images/logo/logo-white.png') }}" alt=""></a>
                                </div>
                        ...
                        <div class="col-md-4 col-lg-3 col-sm-6">
                            <div class="single-wedge">
                                ...
                                <div class="footer-links">
                                    ...
                                    <img src="{{ asset('front/images/icons/payment.png') }}" alt="" class="payment-img img-fulid">
                        ...
                        <div class="col-lg-6 col-sm-12 col-xs-12 mb-lm-30px mb-md-30px mb-sm-30px">
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto"
                                            src="{{ asset('front/images/product-image/zoom-image/1.jpg') }}" alt="">
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto"
                                            src="{{ asset('front/images/product-image/zoom-image/2.jpg') }}" alt="">
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto"
                                            src="{{ asset('front/images/product-image/zoom-image/3.jpg') }}" alt="">
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto"
                                            src="{{ asset('front/images/product-image/zoom-image/4.jpg') }}" alt="">
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-container zoom-thumbs mt-3 mb-3">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto"
                                            src="{{ asset('front/images/product-image/small-image/1.jpg') }}" alt="">
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto"
                                            src="{{ asset('front/images/product-image/small-image/2.jpg') }}" alt="">
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto"
                                            src="{{ asset('front/images/product-image/small-image/3.jpg') }}" alt="">
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto"
                                            src="{{ asset('front/images/product-image/small-image/4.jpg') }}" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
