    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="pages/widgets.html" class="nav-link @yield('widgetsactive')">
          ...
          <li class="nav-item @yield('subcategorycl')">
            ...
            <ul class="nav nav-treeview" style="@yield('displayblock')">
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a href="{{url('subcategories')}}" class="nav-link @yield('subcategoryactive')">
                  <i class="far fa-circle nav-icon"></i>
