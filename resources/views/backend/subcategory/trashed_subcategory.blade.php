                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                      <a class="btn btn-info"href="{{ url('restore-subcategory') }}/{{ $cat->id }}">Restore</a>
                      <a class="btn btn-danger"href="{{ url('permanentdelete-subcategory')}}/{{ $cat->id }}">PermanentDelete</a>
                      </td>
              ...
              <div class="modal fade" id="modal-default" aria-hidden="true" style="display: none;">
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <form action="{{ url('permanentdelete-subcategory') }}" method="post">
                      @csrf
